    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
         <a href="index.php"><h1 style="font-size:30px;color:red;width:50px;margin-left:-20px;height:15px;inline-hegiht:20px">YATRI</h1></a>
        </div>
...
echo "Welcome To Yatri car service";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="my-Feedback.php">My Feedback</a></li>
