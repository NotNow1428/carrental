                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <img
                                                        ...
                                                        width="300" height="200" style="border:solid 1px #000">
                                                    <a
                                                        href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>"><br>Change
                                                        Image 2</a>
                                                </div>
                                                <div class="col-sm-4">
                                                    <img
                                                        ...
                                                        width="300" height="200" style="border:solid 1px #000">
                                                    <a
                                                        href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>"><br>Change
                                                        Image 3</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    <img
                                                        ...
                                                        width="300" height="200" style="border:solid 1px #000">
                                                    <a
                                                        href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>"><br>Change
                                                        Image 4</a>
                                                </div>
                                                <div class="col-sm-4">
                                                    Image 5
