...
{ ?>
                                    ...
                                    <li>
                                        ...
                                        <a href="delete_Feedback.php?id=<?php echo $result->id;?>" class="btn outline btn-xs" onclick="return confirm('Are you sure you want to delete this feedback?');">Delete</a>
